...
public class Global
{
    ...
    public const string AppName = "NetCat";
    public const string AppUpdateRepository = "akapustyanik/NetCat";
    ...
    public const string AutoRunName = "NetCatAutoRun";
    ...
    public const string StartMinimizedToTray = "startintray";
    ...
    public static readonly Dictionary<ECoreType, string> CoreUrls = new()
    {
        ...
        { ECoreType.v2rayN, AppUpdateRepository },
    };
